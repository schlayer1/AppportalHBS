...
export const PasswordGate: React.FC<PasswordGateProps> = ({ onAuthenticated }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F0F8FA] via-[#F8FBFC] to-[#EDF4FF] flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Card */}
        <div className={`bg-white rounded-3xl p-8 sm:p-10 shadow-hbs-card border border-hbs-slate-border/50 backdrop-blur-sm transition-all duration-300 ${hasError ? 'animate-shake' : ''}`}>
          
          {/* School Emblem & Header */}
          <div className="flex flex-col items-center text-center mb-8">
            <div className="relative mb-4 group">
              <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-hbs-blue-soft p-2.5 flex items-center justify-center border-2 border-hbs-blue/20 shadow-md">
                <img 
                  src="/Siegel_bunt.png" 
              ...
              <div className="absolute -bottom-2 -right-2 bg-hbs-blue text-white p-1.5 rounded-full shadow">
                <Lock className="w-4 h-4" />
              </div>
            </div>

            <span className="text-xs font-bold uppercase tracking-wider text-hbs-blue px-3 py-1 bg-hbs-blue-soft rounded-full border border-hbs-blue/15 mb-2">
              Kollegiumszugang
            </span>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-hbs-slate-dark tracking-tight">
              {PORTAL_CONFIG.portalTitle}
            </h1>
            <p className="text-sm font-medium text-hbs-slate-muted mt-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-12 py-3.5 text-sm bg-hbs-bg rounded-xl border font-medium text-hbs-slate-dark placeholder-hbs-slate-light/70 focus:outline-none focus:ring-2 transition-all ${
                    hasError 
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3.5 flex items-center text-hbs-slate-light hover:text-hbs-blue transition-colors"
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer select-none text-xs sm:text-sm text-hbs-slate-muted font-medium">
                <input
                  type="checkbox"
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                  className="w-4 h-4 rounded text-hbs-blue border-hbs-slate-border focus:ring-hbs-blue focus:ring-offset-0 transition"
                />
            ...
            <button
              type="submit"
              className="w-full py-3.5 px-6 rounded-xl bg-gradient-to-r from-hbs-blue-deep to-hbs-blue text-white font-bold text-sm tracking-wide shadow-md hover:shadow-lg hover:from-hbs-blue hover:to-hbs-blue-dark transition-all duration-200 flex items-center justify-center gap-2 group"
            >
        ...
        <p className="text-center text-xs text-hbs-slate-muted mt-6">
